...
class HomeworkSubmission(Base):
    ...
    reviewed_by: Mapped[Optional[int]] = mapped_column(ForeignKey("users.id", ondelete="SET NULL"), nullable=True, index=True)
    ...
    assignment: Mapped["HomeworkAssignment"] = relationship("HomeworkAssignment", back_populates="submissions")
